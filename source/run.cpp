...
int main() {
    ...
    BlueRov.add_DOF(-5,2.,0.,4.,0,true); // acceleration, init velocity, init poition, final position, indx, boolian defining ocv
    BlueRov.add_DOF(0,2.,0.,7.,1,true);
    BlueRov.add_DOF(0,2.,0.,12.,2,true);
    BlueRov.add_DOF(0,2.,0.,4.,3,false);
